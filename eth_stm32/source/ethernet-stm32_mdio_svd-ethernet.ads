...
package Ethernet.STM32_MDIO_SVD.Ethernet is
   pragma Preelaborate;
   ...
   subtype DMABMR_DSL_Field is Interfaces.Unsigned_32 range 0 .. 31;
   subtype DMABMR_PBL_Field is Interfaces.Unsigned_32 range 0 .. 63;
   subtype DMABMR_RTPR_Field is Interfaces.Unsigned_32 range 0 .. 3;
   subtype DMABMR_RDP_Field is Interfaces.Unsigned_32 range 0 .. 63;
   ...
   type DMABMR_Register is record
      ...
      MB             : Boolean := False;
      --  unspecified
      Reserved_27_31 : Interfaces.Unsigned_32 range 0 .. 31 := 16#0#;
   end record
   ...
   subtype DMASR_RPS_Field is Interfaces.Unsigned_32 range 0 .. 7;
   subtype DMASR_TPS_Field is Interfaces.Unsigned_32 range 0 .. 7;
   subtype DMASR_EBS_Field is Interfaces.Unsigned_32 range 0 .. 7;
   ...
   type DMASR_Register is record
      ...
      ETS            : Boolean := False;
      --  unspecified
      Reserved_11_12 : Interfaces.Unsigned_32 range 0 .. 3 := 16#0#;
      --  no description available
      FBES           : Boolean := False;
      --  no description available
      ERS            : Boolean := False;
      ...
      --  unspecified
      Reserved_26_26 : Interfaces.Unsigned_32 range 0 .. 1 := 16#0#;
      --  Read-only. no description available
      MMCS           : Boolean := False;
      --  Read-only. no description available
      PMTS           : Boolean := False;
      ...
      TSTS           : Boolean := False;
      --  unspecified
      Reserved_30_31 : Interfaces.Unsigned_32 range 0 .. 3 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DMAOMR_RTC_Field is Interfaces.Unsigned_32 range 0 .. 3;
   subtype DMAOMR_TTC_Field is Interfaces.Unsigned_32 range 0 .. 7;

   --  Ethernet DMA operation mode register
   type DMAOMR_Register is record
      --  unspecified
      Reserved_0_0   : Interfaces.Unsigned_32 range 0 .. 1 := 16#0#;
      --  SR
      SR             : Boolean := False;
      --  OSF
      OSF            : Boolean := False;
      ...
      --  unspecified
      Reserved_5_5   : Interfaces.Unsigned_32 range 0 .. 1 := 16#0#;
      --  FUGF
      FUGF           : Boolean := False;
      --  FEF
      FEF            : Boolean := False;
      --  unspecified
      Reserved_8_12  : Interfaces.Unsigned_32 range 0 .. 31 := 16#0#;
      --  ST
      ST             : Boolean := False;
      --  TTC
      TTC            : DMAOMR_TTC_Field := 16#0#;
      --  unspecified
      Reserved_17_19 : Interfaces.Unsigned_32 range 0 .. 7 := 16#0#;
      --  FTF
      FTF            : Boolean := False;
      --  TSF
      TSF            : Boolean := False;
      --  unspecified
      Reserved_22_23 : Interfaces.Unsigned_32 range 0 .. 3 := 16#0#;
      --  DFRF
      DFRF           : Boolean := False;
      --  RSF
      RSF            : Boolean := False;
   ...
   type DMAIER_Register is record
      ...
      NISE           : Boolean := False;
      --  unspecified
      Reserved_17_31 : Interfaces.Unsigned_32 range 0 .. 32767 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DMAMFBOCR_MFC_Field is Interfaces.Unsigned_32 range 0 .. 65535;
   subtype DMAMFBOCR_MFA_Field is Interfaces.Unsigned_32 range 0 .. 2047;
   ...
   type DMAMFBOCR_Register is record
      ...
      OFOC           : Boolean := False;
      --  unspecified
      Reserved_29_31 : Interfaces.Unsigned_32 range 0 .. 7 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DMARSWTR_RSWTC_Field is Interfaces.Unsigned_32 range 0 .. 255;
   ...
   type DMARSWTR_Register is record
      ...
      --  unspecified
      Reserved_8_31 : Interfaces.Unsigned_32 range 0 .. 16777215 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype MACCR_BL_Field is Interfaces.Unsigned_32 range 0 .. 3;
   subtype MACCR_IFG_Field is Interfaces.Unsigned_32 range 0 .. 7;

   --  Ethernet MAC configuration register
   type MACCR_Register is record
      --  unspecified
      Reserved_0_1   : Interfaces.Unsigned_32 range 0 .. 3 := 16#0#;
      --  RE
      RE             : Boolean := False;
      --  TE
      TE             : Boolean := False;
      ...
      APCS           : Boolean := False;
      --  unspecified
      Reserved_8_8   : Interfaces.Unsigned_32 range 0 .. 1 := 16#0#;
      --  RD
      RD             : Boolean := False;
      --  IPCO
      IPCO           : Boolean := False;
      ...
      FES            : Boolean := False;
      --  unspecified
      Reserved_15_15 : Interfaces.Unsigned_32 range 0 .. 1 := 16#1#;
      --  CSD
      CSD            : Boolean := False;
      --  IFG
      IFG            : MACCR_IFG_Field := 16#0#;
      --  unspecified
      Reserved_20_21 : Interfaces.Unsigned_32 range 0 .. 3 := 16#0#;
      --  JD
      JD             : Boolean := False;
      --  WD
      WD             : Boolean := False;
      --  unspecified
      Reserved_24_24 : Interfaces.Unsigned_32 range 0 .. 1 := 16#0#;
      --  CSTF
      CSTF           : Boolean := False;
      --  unspecified
      Reserved_26_31 : Interfaces.Unsigned_32 range 0 .. 63 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type MACFFR_Register is record
      ...
      HPF            : Boolean := False;
      --  unspecified
      Reserved_10_30 : Interfaces.Unsigned_32 range 0 .. 2097151 := 16#0#;
      --  no description available
      RA             : Boolean := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype MACMIIAR_CR_Field is Interfaces.Unsigned_32 range 0 .. 7;
   subtype MACMIIAR_MR_Field is Interfaces.Unsigned_32 range 0 .. 31;
   subtype MACMIIAR_PA_Field is Interfaces.Unsigned_32 range 0 .. 31;
   ...
   type MACMIIAR_Register is record
      ...
      --  unspecified
      Reserved_16_31 : Interfaces.Unsigned_32 range 0 .. 65535 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype MACMIIDR_TD_Field is Interfaces.Unsigned_32 range 0 .. 65535;
   ...
   subtype MACFCR_PLT_Field is Interfaces.Unsigned_32 range 0 .. 3;
   subtype MACFCR_PT_Field is Interfaces.Unsigned_32 range 0 .. 65535;
   ...
   type MACFCR_Register is record
      ...
      --  unspecified
      Reserved_6_6  : Interfaces.Unsigned_32 range 0 .. 1 := 16#0#;
      --  no description available
      ZQPD          : Boolean := False;
      --  unspecified
      Reserved_8_15 : Interfaces.Unsigned_32 range 0 .. 255 := 16#0#;
      --  no description available
   ...
   subtype MACVLANTR_VLANTI_Field is Interfaces.Unsigned_32 range 0 .. 65535;
   ...
   type MACPMTCSR_Register is record
      ...
      WFE            : Boolean := False;
      --  unspecified
      Reserved_3_4   : Interfaces.Unsigned_32 range 0 .. 3 := 16#0#;
      --  no description available
      MPR            : Boolean := False;
      --  no description available
      WFR            : Boolean := False;
      --  unspecified
      Reserved_7_8   : Interfaces.Unsigned_32 range 0 .. 3 := 16#0#;
      --  no description available
      GU             : Boolean := False;
      --  unspecified
      Reserved_10_30 : Interfaces.Unsigned_32 range 0 .. 2097151 := 16#0#;
   ...
   type MACSR_Register is record
      --  unspecified
      Reserved_0_2   : Interfaces.Unsigned_32 range 0 .. 7 := 16#0#;
      --  Read-only. no description available
      PMTS           : Boolean := False;
      --  Read-only. no description available
      MMCS           : Boolean := False;
      ...
      TSTS           : Boolean := False;
      --  unspecified
      Reserved_10_31 : Interfaces.Unsigned_32 range 0 .. 4194303 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type MACIMR_Register is record
      ...
      PMTIM          : Boolean := False;
      --  unspecified
      Reserved_4_8   : Interfaces.Unsigned_32 range 0 .. 31 := 16#0#;
      --  no description available
      TSTIM          : Boolean := False;
      --  unspecified
      Reserved_10_31 : Interfaces.Unsigned_32 range 0 .. 4194303 := 16#0#;
   ...
   subtype MACA0HR_MACA0H_Field is Interfaces.Unsigned_32 range 0 .. 65535;
   ...
   type MACA0HR_Register is record
      ...
      --  unspecified
      Reserved_16_30 : Interfaces.Unsigned_32 range 0 .. 32767 := 16#10#;
      --  Read-only. Always 1
      MO             : Boolean := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype MACA1HR_MACA1H_Field is Interfaces.Unsigned_32 range 0 .. 65535;
   subtype MACA1HR_MBC_Field is Interfaces.Unsigned_32 range 0 .. 63;
   ...
   type MACA1HR_Register is record
      ...
      --  unspecified
      Reserved_16_23 : Interfaces.Unsigned_32 range 0 .. 255 := 16#0#;
      --  no description available
   ...
   subtype MACA2HR_MAC2AH_Field is Interfaces.Unsigned_32 range 0 .. 65535;
   subtype MACA2HR_MBC_Field is Interfaces.Unsigned_32 range 0 .. 63;
   ...
   subtype MACA2LR_MACA2L_Field is
     Interfaces.Unsigned_32 range 0 .. 2147483647;
   ...
   type MACA2LR_Register is record
      ...
      --  unspecified
      Reserved_31_31 : Interfaces.Unsigned_32 range 0 .. 1 := 16#1#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype MACA3HR_MACA3H_Field is Interfaces.Unsigned_32 range 0 .. 65535;
   subtype MACA3HR_MBC_Field is Interfaces.Unsigned_32 range 0 .. 63;
   ...
   type MMCCR_Register is record
      ...
      MCFHP         : Boolean := False;
      --  unspecified
      Reserved_6_31 : Interfaces.Unsigned_32 range 0 .. 67108863 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type MMCRIR_Register is record
      --  unspecified
      Reserved_0_4   : Interfaces.Unsigned_32 range 0 .. 31 := 16#0#;
      --  no description available
      RFCES          : Boolean := False;
      --  no description available
      RFAES          : Boolean := False;
      --  unspecified
      Reserved_7_16  : Interfaces.Unsigned_32 range 0 .. 1023 := 16#0#;
      --  no description available
      RGUFS          : Boolean := False;
      --  unspecified
      Reserved_18_31 : Interfaces.Unsigned_32 range 0 .. 16383 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type MMCTIR_Register is record
      --  unspecified
      Reserved_0_13  : Interfaces.Unsigned_32 range 0 .. 16383;
      --  Read-only. no description available
      TGFSCS         : Boolean;
      --  Read-only. no description available
      TGFMSCS        : Boolean;
      --  unspecified
      Reserved_16_20 : Interfaces.Unsigned_32 range 0 .. 31;
      --  Read-only. no description available
      TGFS           : Boolean;
      --  unspecified
   ...
   type MMCTIMR_Register is record
      --  unspecified
      Reserved_0_13  : Interfaces.Unsigned_32 range 0 .. 16383 := 16#0#;
      --  no description available
   ...
   subtype PTPTSCR_TSCNT_Field is Interfaces.Unsigned_32 range 0 .. 3;
   ...
   type PTPTSCR_Register is record
      ...
      --  unspecified
      Reserved_6_7   : Interfaces.Unsigned_32 range 0 .. 3 := 16#0#;
      --  no description available
      ...
      --  unspecified
      Reserved_19_31 : Interfaces.Unsigned_32 range 0 .. 8191 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype PTPSSIR_STSSI_Field is Interfaces.Unsigned_32 range 0 .. 255;
   ...
   subtype PTPTSLR_STSS_Field is Interfaces.Unsigned_32 range 0 .. 2147483647;
   ...
   subtype PTPTSLUR_TSUSS_Field is
     Interfaces.Unsigned_32 range 0 .. 2147483647;
   ...
   type Ethernet_DMA_Peripheral is record
      ...
      DMATPDR   : aliased Interfaces.Unsigned_32;
      --  EHERNET DMA receive poll demand register
      DMARPDR   : aliased Interfaces.Unsigned_32;
      --  Ethernet DMA receive descriptor list address register
      DMARDLAR  : aliased Interfaces.Unsigned_32;
      --  Ethernet DMA transmit descriptor list address register
      DMATDLAR  : aliased Interfaces.Unsigned_32;
      --  Ethernet DMA status register
      ...
      DMACHTDR  : aliased Interfaces.Unsigned_32;
      --  Ethernet DMA current host receive descriptor register
      DMACHRDR  : aliased Interfaces.Unsigned_32;
      --  Ethernet DMA current host transmit buffer address register
      DMACHTBAR : aliased Interfaces.Unsigned_32;
      --  Ethernet DMA current host receive buffer address register
      DMACHRBAR : aliased Interfaces.Unsigned_32;
   end record
     with Volatile;
   ...
   type Ethernet_MAC_Peripheral is record
      ...
      MACHTHR   : aliased Interfaces.Unsigned_32;
      --  Ethernet MAC hash table low register
      MACHTLR   : aliased Interfaces.Unsigned_32;
      --  Ethernet MAC MII address register
      ...
      MACA0LR   : aliased Interfaces.Unsigned_32;
      --  Ethernet MAC address 1 high register
      MACA1HR   : aliased MACA1HR_Register;
      --  Ethernet MAC address1 low register
      MACA1LR   : aliased Interfaces.Unsigned_32;
      --  Ethernet MAC address 2 high register
      ...
      MACA3LR   : aliased Interfaces.Unsigned_32;
   end record
     with Volatile;
   ...
   type Ethernet_MMC_Peripheral is record
      ...
      MMCTGFSCCR  : aliased Interfaces.Unsigned_32;
      --  Ethernet MMC transmitted good frames after more than a single
      --  collision
      MMCTGFMSCCR : aliased Interfaces.Unsigned_32;
      --  Ethernet MMC transmitted good frames counter register
      MMCTGFCR    : aliased Interfaces.Unsigned_32;
      --  Ethernet MMC received frames with CRC error counter register
      MMCRFCECR   : aliased Interfaces.Unsigned_32;
      --  Ethernet MMC received frames with alignment error counter register
      MMCRFAECR   : aliased Interfaces.Unsigned_32;
      --  MMC received good unicast frames counter register
      MMCRGUFCR   : aliased Interfaces.Unsigned_32;
   end record
     with Volatile;
   ...
   type Ethernet_PTP_Peripheral is record
      ...
      PTPTSHR  : aliased Interfaces.Unsigned_32;
      --  Ethernet PTP time stamp low register
      PTPTSLR  : aliased PTPTSLR_Register;
      --  Ethernet PTP time stamp high update register
      PTPTSHUR : aliased Interfaces.Unsigned_32;
      --  Ethernet PTP time stamp low update register
      PTPTSLUR : aliased PTPTSLUR_Register;
      --  Ethernet PTP time stamp addend register
      PTPTSAR  : aliased Interfaces.Unsigned_32;
      --  Ethernet PTP target time high register
      PTPTTHR  : aliased Interfaces.Unsigned_32;
      --  Ethernet PTP target time low register
      PTPTTLR  : aliased Interfaces.Unsigned_32;
      --  Ethernet PTP time stamp status register
...
end Ethernet.STM32_MDIO_SVD.Ethernet;
